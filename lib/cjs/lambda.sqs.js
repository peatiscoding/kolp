...
const makeSQSHandler = (messageHandler, opts) => async (event, context) => {
    var _a, _b;
    ...
    if (opts.deleteMessagePolicy === 'always-delete-on-success' || (opts.deleteMessagePolicy === 'auto' && errorRecords.length > 0)) {
        const sqs = new client_sqs_1.SQSClient(option.sqsConfig || {});
...
exports.makeSQSHandler = makeSQSHandler;
